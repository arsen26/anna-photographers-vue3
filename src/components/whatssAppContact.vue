          ...
          <div class="WhatsappChat__MessageContainer-sc-1wqac52-1 dAbFpq">
            ...
            >
              ...
              <div class="WhatsappChat__Text-sc-1wqac52-2 iSpIQi">
                Pershendetje!<br /><br />Si mund tju ndihmojme?
              </div>
...
setInterval(() => {
  currentTime.value =
    currentDate.getHours() + ':' + String(currentDate.getMinutes()).padStart(2, '0') // Merr orën dhe minutat
}, 10000)
...
const sendMessage = () => {
  if (chatInput.value.trim() !== '') {
    ...
    const fullUrl = `${url}?phone=${phoneNumber.value}&text=${encodeURIComponent(chatInput.value)}`
